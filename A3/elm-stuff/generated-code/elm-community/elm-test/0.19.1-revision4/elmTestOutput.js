...
var $author$project$Card$cardValue = function (_v0) {
	var face = _v0.a;
	switch (face.$) {
		case 'Ace':
			return _List_fromArray(
...
var $author$project$Main$calculateScore = function (cards) {
	var compareScores = F2(
		function (s1, s2) {
			var _v3 = _Utils_Tuple2(s1 > 21, s2 > 21);
			if (!_v3.a) {
				if (_v3.b) {
					return s1;
				} else {
					return (_Utils_cmp(s1, s2) > -1) ? s1 : s2;
				}
			} else {
				if (!_v3.b) {
					return s2;
		...
		function (acc, cardList) {
			...
			while (true) {
				if (!cardList.b) {
					...
					var x = cardList.a;
					var xs = cardList.b;
					var val = $author$project$Card$cardValue(x);
					if (!val.b) {
						return acc;
					} else {
						var y = val.a;
...
var $author$project$Tests$genTest = F4(
	function (name, fn, input, expected) {
		return A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					A4(
					$author$project$Tests$genTest,
					'calculateScore 1',
					$author$project$Main$calculateScore,
					_List_fromArray(
						[
							A2($author$project$Card$Card, $author$project$Card$King, $author$project$Card$Hearts)
						]),
					10),
					A4(
					$author$project$Tests$genTest,
					...
					_List_fromArray(
						[
							A2($author$project$Card$Card, $author$project$Card$TWO, $author$project$Card$Hearts)
						]),
					2),
					A4(
					$author$project$Tests$genTest,
					...
					_List_fromArray(
						[
							A2($author$project$Card$Card, $author$project$Card$TWO, $author$project$Card$Hearts),
							A2($author$project$Card$Card, $author$project$Card$King, $author$project$Card$Spades)
						]),
					12),
					A4(
					$author$project$Tests$genTest,
					...
					_List_fromArray(
						[
							A2($author$project$Card$Card, $author$project$Card$Ace, $author$project$Card$Hearts),
							A2($author$project$Card$Card, $author$project$Card$King, $author$project$Card$Spades)
						]),
					21),
					A4(
					...
					_List_fromArray(
						[
							A2($author$project$Card$Card, $author$project$Card$Ace, $author$project$Card$Hearts),
							A2($author$project$Card$Card, $author$project$Card$FIVE, $author$project$Card$Hearts),
							A2($author$project$Card$Card, $author$project$Card$SEVEN, $author$project$Card$Spades)
						]),
					13),
					A4(
					$author$project$Tests$genTest,
					...
					_List_fromArray(
						[
							A2($author$project$Card$Card, $author$project$Card$King, $author$project$Card$Hearts),
							A2($author$project$Card$Card, $author$project$Card$TEN, $author$project$Card$Clubs),
					...
					_List_fromArray(
						[
							A2($author$project$Card$Card, $author$project$Card$Ace, $author$project$Card$Spades),
							A2($author$project$Card$Card, $author$project$Card$Ace, $author$project$Card$Clubs),
							A2($author$project$Card$Card, $author$project$Card$TEN, $author$project$Card$Clubs),
							A2($author$project$Card$Card, $author$project$Card$King, $author$project$Card$Clubs)
						]),
					22)
				]))
		]));
var $author$project$Test$Generated$Main1786888698$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		globs: _List_Nil,
		paths: _List_fromArray(
			['F:\\Poli\\An3_sem1\\FP\\Project_elm\\tests\\Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 273770186163679
	},
	$elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				'Tests',
				_List_fromArray(
					[$author$project$Tests$suite]))
			])));
_Platform_export({'Test':{'Generated':{'Main1786888698':{'init':$author$project$Test$Generated$Main1786888698$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "\\\\.\\pipe\\elm_test-10840-1";
